export const settingsMediaZh = {
  ...
  "settings.tabTasks": "Activity",
  "settings.tabMedia": "媒体",
  "settings.tabModules": "模块",
  "settings.tabData": "数据",
  "settings.tabTrash": "回收站",
  "settings.externalModules": "外部模块",
  "settings.externalModulesHint":
    "翻译模型和 MinerU 不存放在应用内。选择 Circo-modules 文件夹后即可启用；修改目录无需重启应用。",
  "settings.modulesDirectory": "Circo 模块目录",
  "settings.disconnectModules": "断开目录",
  "settings.translationModule": "中英翻译",
  "settings.modulesStructure":
    "目录应包含 translation/models 和 mineru 两个模块；缺失的模块不会影响其他功能。",
  "settings.deleteForever": "永久删除",
  "settings.confirmDeleteForever": "确定要永久删除此记录吗？此操作无法恢复。",
  "settings.taskPreprocessing": "Activity 预处理规则",
  "settings.taskPreprocessingHint":
    "每个自定义 Activity list 对应一条规则。根据 Activity 名称中的关键词自动填充预计用时、预期产出和评分。",
  ...
  "settings.taskPreprocessingSaved": "Activity 预处理规则已保存。",
...
export const settingsMediaEn: Record<keyof typeof settingsMediaZh, string> = {
  ...
  "settings.tabTasks": "Activities",
  "settings.tabMedia": "Media",
  "settings.tabModules": "Modules",
  "settings.tabData": "Data",
  "settings.tabTrash": "Trash",
  "settings.externalModules": "External modules",
  "settings.externalModulesHint":
    "Translation models and MinerU live outside the app. Select a Circo-modules folder to enable them; changing it does not require an app restart.",
  "settings.modulesDirectory": "Circo modules directory",
  "settings.disconnectModules": "Disconnect folder",
  "settings.translationModule": "English–Chinese translation",
  "settings.modulesStructure":
    "The folder should contain translation/models and mineru. A missing module does not affect other features.",
  ...
  "settings.taskPreprocessing": "Activity preprocessing rules",
  "settings.taskPreprocessingHint":
    "Each custom Activity list has one rule. Keywords in the Activity name fill duration, expected output, and scores.",
  ...
  "settings.taskPreprocessingSaved": "Activity preprocessing rules saved.",
