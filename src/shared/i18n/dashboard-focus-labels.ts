export const dashboardFocusZh = {
  ...
  "dashboard.focusOnline": "Online",
  "dashboard.focusOffline": "Offline",
  "dashboard.focusStart": "开始时间",
  "dashboard.focusEnd": "结束时间",
  "dashboard.focusDuration": "时长（分钟）",
...
export const dashboardFocusEn: Record<keyof typeof dashboardFocusZh, string> = {
  ...
  "dashboard.focusOnline": "Online",
  "dashboard.focusOffline": "Offline",
  "dashboard.focusStart": "Start time",
  "dashboard.focusEnd": "End time",
  "dashboard.focusDuration": "Duration (minutes)",
