...
import type { TaskListInput } from "../view-models/use-task-library";
...
export function TaskListDialog({
  ...
  list?: TaskList;
  onClose: () => void;
  onSave: (input: TaskListInput) => void;
}) {
  const { t } = useI18n();
...
export function ChooseTaskListDialog({
  lists,
  onClose,
  onChoose,
}: {
